                    ...
                    @foreach($kotas as $row)
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="edit" href="{{ route('kegiatan.index', $row->id_kota) }}" data-toggle="tooltip" data-placement="top" title="Edit KoTA"><i class="nav-icon fas fa-calendar" style="color: gray;"></i></a>                     
