        ...
        <div class="alert" role="alert" style="background-color: #D2DCF2;">
          <div class="row">
            ...
            <div class="col-5 d-md-flex justify-content-md-end">
              <div class="mr-2">
                <span class="badge bg-light text-dark me-3">Jumlah Bimbingan : {{ $progressStage1Count }}</span>
              </div>
              @if (auth()->user()->role == '2')
                    ...
                    <form action="{{ route('store_status') }}" method="POST" id="statusForm_{{ $item->id }}">
                      ...
                      <div class="form-group">
                        <select class="form-control-sm" id="statusControlSelect_{{ $item->id }}" name="status"
                          ...
                          <option value="belum-disetujui" class="badge badge-danger" disabled
                            {{ $item->status == 'belum-disetujui' ? 'selected' : '' }}>Belum Disetujui</option>
                          <option value="disetujui" class="badge badge-success"
            ...
            <div class="col justify-content-md-end">
              <div class="progress" style="height: 25px;">
                <div class="progress-bar" role="progressbar"
                  style="width: {{ number_format($selesaiPercentage2, 1) }}%;"
        ...
        <div class="alert" role="alert" style="background-color: #D2DCF2;">
          <div class="row">
            ...
            <div class="col justify-content-md-end">
              <div class="progress" style="height: 25px;">
                <div class="progress-bar" role="progressbar"
                  style="width: {{ number_format($selesaiPercentage3, 1) }}%;"
        ...
        <div class="alert" role="alert" style="background-color: #D2DCF2;">
          <div class="row">
            ...
            <div class="col justify-content-md-end">
              <div class="progress" style="height: 25px;">
                <div class="progress-bar" role="progressbar"
                  style="width: {{ number_format($selesaiPercentage4, 1) }}%;"
