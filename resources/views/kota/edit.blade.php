            ...
            <div class="col-md-12">
                ...
                <div class="row align-items-start">
                  ...
                  <div class="col mb-8pt mb-md-0">
                    <select multiple class="form-control" id="dosen" name="dosen[]" required>
                      @foreach ($dosen as $d)
                        <option value="{{ $d->id }}" {{ in_array($d->id, $list_id_user) ? 'selected' : '' }}>
                          {{ $d->name }}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="col mb-8pt mb-md-0">
                    <select multiple class="form-control" id="mahasiswa" name="mahasiswa[]" required>
                      @foreach ($mahasiswa as $m)
                        <option value="{{ $m->id }}" {{ in_array($m->id, $list_id_user) ? 'selected' : '' }}>
                          {{ $m->name }}</option>
                      @endforeach
                    </select>
                  </div>
              ...
              <div class="list-group-item p-3">
                <div class="row align-items-start">
                  ...
                  <div class="col mb-8pt mb-md-0">
                    <input name="judul" value="{{ old('judul', $kota->judul) }}" type="text" class="form-control"
                ...
                <div class="row align-items-start">
                  ...
                  <div class="col mb-8pt mb-md-0">
                    <select name="mitra" class="form-control" id="mitra" required>
                      ...
                      <option value="Non-mitra" {{ old('mitra', $kota->mitra) == 'Non-mitra' ? 'selected' : '' }}>
                        Non-mitra</option>
                      <option value="Organisasi" {{ old('mitra', $kota->mitra) == 'Organisasi' ? 'selected' : '' }}>
                        Organisasi</option>
                      <option value="Industri" {{ old('mitra', $kota->mitra) == 'Industri' ? 'selected' : '' }}>Industri
                      </option>
                    </select>
                  </div>
                </div>
                ...
                <div class="row align-items-start">
                  ...
                  <div class="col mb-8pt mb-md-0">
                    <select name="luaran" class="form-control" id="luaran" required>
                      ...
                      <option value="Jurnal" {{ old('luaran', $kota->luaran) == 'Jurnal' ? 'selected' : '' }}>Jurnal
                      </option>
                    </select>
                  </div>
                </div>
