                      ...
                      @if (auth()->user()->role == '1')
                        <div class="mr-2">
                          ...
                          <a href="#" data-toggle="modal" data-toggle="tooltip" data-placement="top"
                            title="Edit Timeline" data-target="#editTimelineModal-{{ $timeline->id_timeline }}">
                            <i class="nav-icon fas fa-pen" style="color: blue;"></i>
                          </a>
                          <!-- Delete Button trigger modal -->
                          <a href="#" data-toggle="modal" data-placement="top" title="Delete Timeline"
                            data-target="#deleteTimelineModal-{{ $timeline->id_timeline }}">
                    ...
                    <div class="timeline-footer">
                      ...
                      <div class="modal fade" id="editTimelineModal-{{ $timeline->id_timeline }}" tabindex="-1"
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="editTimelineModalLabel-{{ $timeline->id_timeline }}">Edit
                                Timeline</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
