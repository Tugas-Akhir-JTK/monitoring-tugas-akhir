            ...
            <div class="card-body">
              ...
              <div class="row g-2">
                <div class="col mb-3">
                  ...
                  <input name="sesi_bimbingan" value="{{ old('sesi_bimbingan') }}" type="text" class="form-control"
                    id="sesi_bimbingan" placeholder="Sesi Bimbingan Ke-" />
                </div>
                <!-- TAHAPAN PROGRES -->
                <div class="col mb-3">
                  ...
                  <select name="tahapan_progres" class="form-control" id="tahapan_progres" required>
                    ...
                    <option value="1" {{ old('tahapan_progres') == 1 ? 'selected' : '' }}>Seminar 1</option>
              ...
              <div class="row g-2">
                ...
                <div class="col mb-3">
                  ...
                  <input name="tanggal_bimbingan" value="{{ old('tanggal_bimbingan') }}" type="date"
                    class="form-control" id="tanggal_bimbingan" placeholder="dd/mm/yy" required />
                </div>

                <!-- WAKTU BIMBINGAN -->
                <div class="col mb-3">
                  <label for="jam_mulai" class="form-label">Jam Mulai</label>
                  <input name="jam_mulai" value="{{ old('jam_mulai') }}" type="time" class="form-control"
                    id="jam_mulai" placeholder="hh:mm" required />
                </div>

                <div class="col mb-3">
                  <label for="jam_selesai" class="form-label">Jam Selesai</label>
                  <input name="jam_selesai" value="{{ old('jam_selesai') }}" type="time" class="form-control"
                    id="jam_selesai" placeholder="hh:mm" required />
                </div>
              </div>
