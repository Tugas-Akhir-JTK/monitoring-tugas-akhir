        ...
        <div class="row">
          ...
          <div class="col d-flex justify-content-end">
            ...
            <div class="btn-group mr-2">
              ...
              <div class="dropdown">
                <button class="btn btn-secondary dropdown-toggle" type="button" id="seminarsDropdown"
                  data-toggle="dropdown" aria-expanded="false">
                  Tahapan TA
                </button>
                <ul class="dropdown-menu" aria-labelledby="seminarsDropdown">
                  <li><a href="{{ route('resume', ['sort' => 'tahapan_progres', 'direction' => 'asc', 'value' => 2]) }}"
                      class="dropdown-item">Seminar 2</a></li>
                  <li><a href="{{ route('resume', ['sort' => 'tahapan_progres', 'direction' => 'asc', 'value' => 3]) }}"
                      class="dropdown-item">Seminar 3</a></li>
                  <li><a href="{{ route('resume', ['sort' => 'tahapan_progres', 'direction' => 'asc', 'value' => 4]) }}"
    ...
    <div class="content">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-4 shadow">
          <div class="card-body">
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4 mt-4 p-3">
                  ...
                  <div class="card">
                    <h5 class="card-header d-flex justify-content-between align-items-center">
                      ...
                      @if (auth()->user()->role == '3')
                        <div class="col d-grid d-md-flex justify-content-md-end gap-2">
                          <div class="btn-group mr-2">
                            <a href="{{ route('resume.edit', $resume->id_resume_bimbingan) }}" data-toggle="tooltip"
                              data-placement="top" title="Edit Resume Bimbingan">
                              <i class="nav-icon fas fa-pen" style="color: blue;"></i>
                            </a>
                          </div>
                          <div class="btn-group">
                            <a href="{{ route('resume.generatePdf', ['sesi_bimbingan' => $resume->id_resume_bimbingan]) }}"
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <p class="col"><small class="text-muted">{{ $resume->jam_mulai }} -
                            {{ $resume->jam_selesai }}</small></p>
                        <div class="row">
                          <div class="col">
                            @php
                              $maxLength = 100;
                              ...
                              $shortContent =
                                  strlen($content) > $maxLength ? substr($content, 0, $maxLength) . '...' : $content;
                            @endphp
                            <h5>Resume</h5>
                            <small>
                              {{ $shortContent }}
                              @if (strlen($content) > $maxLength)
                                <a href="{{ route('resume.detail', ['id' => $resume->id_resume_bimbingan]) }}">Baca
                                  Selengkapnya</a>
                              @endif
                            </small>
                          </div>
