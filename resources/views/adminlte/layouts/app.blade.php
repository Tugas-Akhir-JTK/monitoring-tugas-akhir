...
<head>
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet"
    href="{{ asset('assets/AdminLTE-3.2.0/plugins/overlayScrollbars/css/OverlayScrollbars.min.css') }}">
  <!-- Daterange picker -->
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link text-center">
        <img id="polban-logo" src="{{ asset('assets/dist/img/polban.png') }}" id="polban-logo" alt="Polban Logo"
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
            ...
            @if (auth()->user()->role == '3')
              <li class="nav-item">
                <a href="#artefakCollapse" class="nav-link" data-toggle="collapse" role="button"
                  aria-expanded="false" aria-controls="artefakCollapse">
                  <i class="nav-icon fas fa-file"></i>
                  <p>
                    Artefak
                    <!-- <span class="right badge badge-danger">New</span> -->
            ...
            @if (auth()->user()->role == '3')
              <li class="nav-item">
                <a href="#jadwalCollapse" class="nav-link" data-toggle="collapse" role="button"
                  aria-expanded="false" aria-controls="jadwalCollapse">
                  <i class="nav-icon fas fa-clock"></i>
                  <p>
                    Jadwal
                    <!-- <span class="right badge badge-danger">New</span> -->
    ...
    <!-- overlayScrollbars -->
    <script src="{{ asset('assets/AdminLTE-3.2.0/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js') }}">
    </script>
